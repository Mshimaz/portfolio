        ...
        <section className="section" id="contact">
            <div className="container text-center">
                ...
                <motion.p
                    ...
                    className="text-slate-300 max-w-2xl mx-auto mb-12 text-lg"
                >
                    I'm currently looking for new opportunities in Mobile App Development (Flutter) and AI roles.
                ...
                >
                    ...
                    <div className="flex gap-4 mt-4">
                        <a
                            ...
                            className="w-12 h-12 rounded-full bg-slate-800 flex items-center justify-center text-slate-300 hover:text-white hover:bg-blue-600 transition-all border border-slate-700"
                            title="LinkedIn"
                        >
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="w-12 h-12 rounded-full bg-slate-800 flex items-center justify-center text-slate-300 hover:text-white hover:bg-gray-700 transition-all border border-slate-700"
                            title="GitHub"
                        >
